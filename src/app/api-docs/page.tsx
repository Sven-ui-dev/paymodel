...
export default function ApiDocsPage() {
  ...
  const t = locale === "de" ? {
    ...
    intro: "Dokumentation für die paymodel.ai API. Alle Rechte vorbehalten.",
    authentication: "Authentifizierung",
    authDesc: "Alle API-Anfragen erfordern einen API-Key im Authorization-Header:",
    models: "Modelle",
    modelsDesc: "Liste alle verfügbaren AI-Modelle mit Preisen und Spezifikationen auf.",
    queryParams: "Query-Parameter",
    param: "Parameter",
    type: "Typ",
    description: "Beschreibung",
    response: "Response-Beispiel",
    compare: "Preisvergleich",
    compareDesc: "Vergleiche die Preise mehrerer Modelle für einen definierten Token-Einsatz.",
    requestBody: "Request-Body",
    calculate: "Kostenrechner",
    calculateDesc: "Berechne die Kosten für ein einzelnes Modell mit flexiblen Token-Parametern.",
    proxy: "API Proxy",
    proxyDesc: "Leite Anfragen an AI-Provider weiter und tracke die Kosten automatisch.",
    requestBodyParams: "Request-Body:",
    supportedProviders: "Unterstützte Provider:",
    provider: "Provider",
    examples: "Model-Beispiele",
    costTracking: "Kosten-Tracking:",
    costTrackingDesc: "Alle Anfragen werden automatisch in der Datenbank erfasst. Sieh deine Kosten im Dashboard unter Kosten-Übersicht.",
    sdks: "SDKs",
    javascript: "JavaScript / TypeScript",
    python: "Python",
    install: "Installieren mit",
    rateLimits: "Rate Limits",
    rateLimitsDesc: "Die API unterliegt Rate Limits um Missbrauch zu verhindern.",
    limit: "Limit",
    period: "Zeitraum",
    perMinute: "Anfragen pro Minute",
    note: "Hinweis",
    noteText: "Für produktive Nutzung empfehlen wir einen kostenpflichtigen Plan.",
  } : {
    title: "API Documentation",
    intro: "Documentation for the paymodel.ai API. All rights reserved.",
    authentication: "Authentication",
    authDesc: "All API requests require an API key in the Authorization header:",
    models: "Models",
    modelsDesc: "List all available AI models with prices and specifications.",
    ...
    compareDesc: "Compare prices of multiple models for a defined token usage.",
    requestBody: "Request Body",
    calculate: "Cost Calculator",
    calculateDesc: "Calculate costs for a single model with flexible token parameters.",
    proxy: "API Proxy",
    proxyDesc: "Forward requests to AI providers and automatically track costs.",
    requestBodyParams: "Request Body:",
    supportedProviders: "Supported Providers:",
    provider: "Provider",
    examples: "Model Examples",
    costTracking: "Cost Tracking:",
    costTrackingDesc: "All requests are automatically recorded in the database. View your costs in the dashboard under Cost Overview.",
    sdks: "SDKs",
    javascript: "JavaScript / TypeScript",
    python: "Python",
    install: "Install with",
    rateLimits: "Rate Limits",
    rateLimitsDesc: "The API is subject to rate limits to prevent abuse.",
    limit: "Limit",
    period: "Period",
    perMinute: "Requests per minute",
    note: "Note",
    noteText: "For production use, we recommend a paid plan.",
  };
